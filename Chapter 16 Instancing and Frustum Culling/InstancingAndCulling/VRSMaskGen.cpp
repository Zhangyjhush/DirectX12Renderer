...
VRSMaskGenPass::VRSMaskGenPass(ID3D12Device* device, UINT width, UINT height, DXGI_FORMAT format)
{
	md3dDevice = device;
...
CD3DX12_GPU_DESCRIPTOR_HANDLE VRSMaskGenPass::OuputSrv()
{
	return mhGpuSrv;
}

UINT VRSMaskGenPass::DescriptorCount() const
{
	return 2;
}

void VRSMaskGenPass::BuildDescriptors(CD3DX12_CPU_DESCRIPTOR_HANDLE hCpuDescriptor, CD3DX12_GPU_DESCRIPTOR_HANDLE hGpuDescriptor, UINT descriptorSize)
{
...
void VRSMaskGenPass::OnResize(UINT newWidth, UINT newHeight)
{
...
void VRSMaskGenPass::Execute(ID3D12GraphicsCommandList* cmdList, ID3D12RootSignature* rootSig, ID3D12PipelineState* pso, CD3DX12_GPU_DESCRIPTOR_HANDLE input)
{
...
void VRSMaskGenPass::BuildDescriptors()
{
...
void VRSMaskGenPass::BuildResource()
{
